...
![Graph_summary.svg](OA-workflow/Graph_summary.svg)
...
| Параметр                                     | Значение                                       |
|--------------------------------------------|------------------------------------------------|
| CurvedLength                               | Значение CurvedLength                          |
| MeanRadius                                 | Значение MeanRadius                            |
| Volume                                     | Значение Volume                                |
| OrientationTheta                           | Значение OrientationTheta                      |
| OrientationPhi                             | Значение OrientationPhi                        |
| ChordLength                                | Значение ChordLength                           |
| Tortuosity                                 | Значение Tortuosity                            |
| Number of empty endpoints                  | Значение Number of empty endpoints             |
| Number of branchpoints                     | Значение Number of branchpoints                |
| Max Coordination Number                    | Значение Max Coordination Number               |
| Volume_Sum_perImage [um^3]                 | Значение Volume_Sum_perImage [um^3]           |
| Geometrical_Volume_perImage [um^3]         | Значение Geometrical_Volume_perImage [um^3]   |
| Imaging_Error_perImage                     | Значение Imaging_Error_perImage                |
| Vessels_CurvedLength_Sum_perImage [um]     | Значение Vessels_CurvedLength_Sum_perImage [um]|
| Weighted_MeanRadius_perImage [um]          | Значение Weighted_MeanRadius_perImage [um]     |
| Weighted_MeanTortuosity_perImage           | Значение Weighted_MeanTortuosity_perImage      |
| Weighted_Segment_MeanRadius_perSegment [um]| Значение Weighted_Segment_MeanRadius_perSegment|
| Weighted_Segment_Tortuosity_perSegment     | Значение Weighted_Segment_Tortuosity_perSegment|
| Weighted_Segment_Volume_perSegment [um^3]  | Значение Weighted_Segment_Volume_perSegment [um^3]|
| Total Image Volume [nm^3]                  | Значение Total Image Volume [nm^3]             |
| ROI Volume [nm^3]                          | Значение ROI Volume [nm^3]                     |
| Vessels in ROI Volume (Labeled Volume after pruning before denoizing) [nm^3] | Значение Vessels in ROI Volume (Labeled Volume after pruning before denoizing) [nm^3] |
| Ratio of ROI Mask to whole image           | Значение Ratio of ROI Mask to whole image      |
| Ratio of Vessel Mask to whole image         | Значение Ratio of Vessel Mask to whole image    |
| Ratio of Vessel Mask to background ROI      | Значение Ratio of Vessel Mask to background ROI |
